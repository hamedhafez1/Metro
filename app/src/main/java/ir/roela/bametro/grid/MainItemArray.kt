...
//        MainItemModel(MapType.TEHRAN_METRO_BRT_COMBINED, R.string.metro_brt_combined, R.drawable.ic_bus_48),
...
//        MainItemModel(MapType.ISTANBUL_METRO, R.string.istanbul_metro, R.drawable.ic_istanbul_galata_tower),
//        MainItemModel(MapType.DUBAI_METRO, R.string.dubai_metro, R.drawable.ic_dubai_burj_al_arab),
    )
}